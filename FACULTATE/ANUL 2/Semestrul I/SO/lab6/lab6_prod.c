...
int p;		// partea comuna dintre cele 2 matrici
		// mat1 = m*p , mat2 = p*n

int **mat1,**mat2; // sa fie si astea globale
...
{ 
	...
	l2 =(int) aux->coloana;
   	for(i=0;i<p;i++)			// fac inmultirea pt a afla elementul din mat3[i][j]
   		s+=mat1[l1][i]*mat2[i][l2];
   		
   	return (void*)s; 			// returnez (void*)(valoarea_lui_s)
  } 		
...
int main(int argc, char** argv) {
	...
	int nr_elemente = m*n;	//  <=> nr de thread-uri  (cerinta zice sa avem un thread pt fiecare element din matrice)
