...
-- subprogram stocat independent care sã utilizeze douã tipuri diferite de colectii
...
--    RETURN 'Nu au fost gãsite închirieri pentru acest client';
--    WHEN TOO_MANY_ROWS THEN
--    RETURN 'Acest client a inchiriat de mai multe ori';
    
    WHEN v_exc1 THEN
        RAISE_APPLICATION_ERROR(-20011,'Nu au fost gãsite închirieri pentru acest client');
...
-- apelarea functiei pentru un ID de client care nu existã
