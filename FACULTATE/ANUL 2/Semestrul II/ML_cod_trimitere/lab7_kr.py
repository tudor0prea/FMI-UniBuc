...
class InfoJoc:
    ...
    def mutari(self, jucator):  # jucator = simbolul jucatorului care muta  ###echivalent cu fct succesori din A*
        l_mutari=[]
...
class Stare:
    ...
    Echivalentul lui NodArbore in A*!
    """
...
def alpha_beta(alpha, beta, stare):
    ...
    if stare.j_curent == InfoJoc.JMAX:
        ...
        for mutare in stare.mutari_posibile:
            ...
            if mutareExpandata.estimare > scorMaxim:
                ...
                for mutare in stare.mutari_posibile:
                    mutareExpandata = alpha_beta(alpha, beta, mutare)
                    if mutareExpandata.estimare < scorMinim:
